<?php
namespace WPLC\Boilerplate\AdminActions;

use WPLC\Boilerplate as Plugin;
use WPLC\Boilerplate\Settings as Settings;
...
function enqueuePubResources()
{
    ...
    wp_enqueue_script(
        Plugin\SETTING_NAME . "-admin-javascript",
        $urlStem . "/pub/admin.js",
        null,
        $pluginVersion,
        true
    );
    ...
    wp_enqueue_style(
        Plugin\SETTING_NAME . "-admin-css",
        $urlStem . "/pub/admin.css",
        null,
        $pluginVersion,
        "screen"
    );
