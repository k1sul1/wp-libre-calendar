<?php
namespace WPLC\Boilerplate\Settings;

use WPLC\Boilerplate as Plugin;
use WPLC\Boilerplate\AdminActions as AdminActions;
...
function sanitize($input)
{
    ...
    foreach ($settings[S_FIELDS] as $attribs) {
        ...
        try {
            $transientValue = call_user_func($sanitizer, $transientValue);
            ...
            AdminActions\addSettingsError($e->message);
        }
